...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public JwtAuthenticationTokenFilter authenticationTokenFilterBean() throws Exception {
        ...
        RequestMatcher getRequestMatcher = new AntPathRequestMatcher("/apiasd/**", HttpMethod.GET.name(), false);
        RequestMatcher postRequestMatcher = new AntPathRequestMatcher("/apiasd/**", HttpMethod.POST.name(), false);
