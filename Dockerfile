...
-Dserver.redirecturl.basepath=${SERVER_BASEPATH} -Dserver.appsystem.basepath=http://35.158.247.216:9001 -Djwt.secret=1#233z366s_>2e-!2ef? -Dserver.port=9002 -Xms500m -Xmx1g -Ddbname=sdp_test -Ddbusername=applications_test -Ddbpassword=StrongPassw0rdHere -Ddbhost=codecool-central.cafzixbagnyd.eu-central-1.rds.amazonaws.com -Ddbport=5432"
